...
public class NecromineMapEditor extends MapEditor implements GuiEventsSubscriber {
	...
	public NecromineMapEditor(final int width, final int height) {
		...
		inflater = new MapInflater(assetsManager, cursorHandler, initializedTiles);
	...
	public void render() {
		update();
		renderer.draw(mode, placedElements, initializedTiles, selectedElement);
	}
	...
	public boolean touchDown(final int screenX, final int screenY, final int pointer, final int button) {
		...
		return handlers.getActionsHandler().onTouchDown(assetsManager, initializedTiles);
	}

...
import com.necromine.editor.actions.processes.LiftTilesFinishProcessParameters;
...
import com.necromine.editor.handlers.ActionHandlerRelatedData;
...
public class ActionsHandler {
            ...
            if (modeClass.equals(EditModes.class)) {
                ...
                if (mode == EditModes.TILES && currentProcess == null) {
                    if (tool == TilesTools.BRUSH) {
                        ...
                        beginTileLiftProcess(1, assetsManager, wallCreator, initializedTiles);
    ...
    private boolean beginTileLiftProcess(final int direction,
        ...
        currentProcess = ProcessBuilder.begin(data.getMap(), assetsManager, src)
    ...
    private void finishProcess(final Assets.FloorsTextures selectedTile, final Model cursorTileModel) {
        ...
        } else if (currentProcess instanceof LiftTilesProcess) {
            LiftTilesProcess currentProcess = (LiftTilesProcess) this.currentProcess;
            currentProcess.finish(new LiftTilesFinishProcessParameters(dstRow, dstCol, eventsNotifier));
        }
